...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/usr/local/zend/apache2/htdocs/symphony1/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/usr/local/zend/apache2/htdocs/symphony1/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'shaklee1', 'host' => 'ecmdbt02.shaklee.com', 'port' => '60004', 'user' => 'icshktst', 'password' => 'test123', 'charset' => 'UTF8', 'driver' => 'pdo_ibm', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b4b02860511369a2a2ee15d0f50cfcaa');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b4b02860511369a2a2ee15d0f50cfcaa');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b4b02860511369a2a2ee15d0f50cfcaa');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/usr/local/zend/apache2/htdocs/symphony1/src/Shaklee/PWSBundle/Entity')), 'Shaklee\\PWSBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ShakleePWSBundle' => 'Shaklee\\PWSBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/usr/local/zend/apache2/htdocs/symphony1/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '9ed4b90d27d41ab8bf860ec5eb341e3a8f1cc3b6');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/usr/local/zend/apache2/htdocs/symphony1/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/usr/local/zend/apache2/htdocs/symphony1/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/usr/local/zend/apache2/htdocs/symphony1/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/usr/local/zend/apache2/htdocs/symphony1/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/src/Shaklee/PWSBundle/Resources/views', 'ShakleePWS');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/app/Resources/views');
        $instance->addPath('/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9ed4b90d27d41ab8bf860ec5eb341e3a8f1cc3b6');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/usr/local/zend/apache2/htdocs/symphony1/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev',
            'kernel.logs_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/logs',
            'kernel.bundles' => array(
                ...
                'ShakleePWSBundle' => 'Shaklee\\PWSBundle\\ShakleePWSBundle',
            ...
            'database_driver' => 'pdo_ibm',
            'database_host' => 'ecmdbt02.shaklee.com',
            'database_port' => '60004',
            'database_name' => 'shaklee1',
            'database_user' => 'icshktst',
            ...
            'locale' => 'en',
            'secret' => '9ed4b90d27d41ab8bf860ec5eb341e3a8f1cc3b6',
            'database_path' => NULL,
            ...
            'debug.container.dump' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '9ed4b90d27d41ab8bf860ec5eb341e3a8f1cc3b6',
            ...
            'session.save_path' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/usr/local/zend/apache2/htdocs/symphony1/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/profiler',
            ...
            'router.resource' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/usr/local/zend/apache2/htdocs/symphony1/app/../web',
            'assetic.write_to' => '/usr/local/zend/apache2/htdocs/symphony1/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/usr/local/zend/apache2/htdocs/symphony1/app/cache/dev/doctrine/orm/Proxies',
